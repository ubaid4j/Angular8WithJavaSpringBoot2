...
public interface FeignProxy {
    ...
    public Todo updateTodo(@PathVariable("username") String username, @RequestBody Todo todo);

    @DeleteMapping("todo-service/users/{username}/todos/{id}")
    public Todo deleteTodo(@PathVariable("username") String usernname, @PathVariable("id") int id);
}
